...
return [
    ...
    'exception' => [
        ...
        'missing_ean_column'             => 'This HTM file has no EAN (Bar code) column, so products cannot be matched. Please ask naiskonsultants@gmail.com to send the .HTM invoice with the EAN (Bar code) column included.',
